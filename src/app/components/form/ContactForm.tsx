  ...
  return (
    <div className="w-full">
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-md mx-auto">
        ...
        <button type="submit" className="cursor-pointer w-full bg-primary rounded-lg py-2">
          <Text
      ...
      >
        <div className="w-full flex flex-col gap-6 mb-2 justify-center items-center">
          ...
          />
          <Link href={"/"} onClick={() => setOpen(false)} className="w-full md:w-fit rounded-lg md:rounded-xl bg-gradient-to-br from-primary to-secondary text-white px-2 py-1 md:px-4 text-center">
            Back to Home
          </Link>
        </div>
      </PopUp>
